...
export const MascotaDemo = () => {
  ...
  const estados = ['neutral', 'pensando', 'alerta', 'sereno', 'activo', 'error'];
  ...
  return (
    <div style={{ 
        ...
        {estados.map(estado => (
          <div 
            ...
            style={{ 
              textAlign: 'center',
              padding: '1.5rem',
              background: estadoActual === estado ? 'rgba(0,0,0,0.03)' : 'transparent',
              borderRadius: '12px',
              cursor: 'pointer',
              transition: 'all 0.3s ease'
            }}
      ...
      <MascotaAdherida
        ...
        estado={estadoActual}
        energia={0.6}
        mensaje={estadoActual !== 'neutral' ? `Estado actual: ${estadoActual}` : null}
      />
    </div>
  );
};
