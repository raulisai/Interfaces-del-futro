...
export const OraculoDemo = () => {
  ...
  // Simular cambios de contexto
  useEffect(() => {
    const interval = setInterval(() => {
      setContexto(prev => ({
        urgencia: Math.random(),
        relevancia: Math.random(),
        emocion: ['neutral', 'curioso', 'alerta', 'sereno'][Math.floor(Math.random() * 4)]
      }));
    }, 5000);
    ...
    <div style={{ 
      ...
      <div style={{ padding: '2rem', maxWidth: '600px' }}>
        ...
        <p style={{ opacity: 0.6, lineHeight: 1.6 }}>
          Una interfaz que solo habla cuando tiene algo relevante que decir.
          El silencio es parte del diseño.
        </p>
